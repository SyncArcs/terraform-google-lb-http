...
resource "google_compute_target_https_proxy" "default" {
  ...
  certificate_map   = var.certificate_map != null ? "//certificatemanager.googleapis.com/projects/${data.google_client_config.current.project}/locations/global/certificateMaps/${var.certificate_map}" : null
...
resource "google_compute_backend_service" "default" {
  ...
  edge_security_policy = lookup(each.value, "edge_security_policy", var.edge_security_policy)
